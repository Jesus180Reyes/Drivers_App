...
import 'package:drivers_app/tabsPages/homeTabPages.dart';
      ...
      children: [
        ...
        Container(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                Text('Total Ganancias', style: TextStyle(color: Colors.white),),
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 16,),
                Text('Total Viajes', style: TextStyle(fontSize: 16), ),
